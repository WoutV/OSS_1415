...
public abstract class Model {
	...
	public List<String> commonWords = new ArrayList<String>(Arrays.asList("the", "be", "to", "of","and","in","that","a",","));
	 ...
	 * @param occurences
	 */
	protected List<String> removeCommonWords(List<String> occurences){
